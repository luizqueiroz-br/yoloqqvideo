...
urlpatterns = [
    ...
    path("api/model-health/", views.model_health_api, name="model_health_api"),
    path("api/hf-auth-status/", views.hf_auth_status_api, name="hf_auth_status_api"),
    path("api/hf-connect/", views.hf_connect_api, name="hf_connect_api"),
